...
import com.example.bank.account.application.account.AccountApplicationService;
import com.example.bank.account.application.account.CreditAmountToAccountCommand;
import com.example.bank.account.application.account.OpenAccountCommand;
import com.example.bank.account.application.account.DebitAmountFromAccountCommand;
import com.example.bank.account.domain.model.account.transaction.Transaction;
import com.example.bank.account.port.adapter.controller.account.transaction.TransactionRequest;
import com.example.bank.account.port.adapter.controller.account.transaction.TransactionResponse;
